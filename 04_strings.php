...
// echo "12 - " . strpos($string, 'world') . '<br>'; //searches for a word in given string
...
// Adding string to a number or length
// $number1 = 100; // 000000100
// $number2 = 123456; // 00123456

// $i = 1;
// while($i <= 2000000){
//     echo str_pad($i, 9, '22', STR_PAD_LEFT)."\n";
//     if($i == 1008353){
//         break;
//     }
//     $i++;
